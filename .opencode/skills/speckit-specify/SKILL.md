...
> **Role of this skill:** Define WHAT/WHY (requirements, user stories, acceptance criteria). Use the product & business context below; do NOT choose the tech stack here.
...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| Assessment brief              | Scope and hard requirements of the technical assessment (source of the product scope)                               | `fullstack-engineer-technical-assessment.pdf` |
